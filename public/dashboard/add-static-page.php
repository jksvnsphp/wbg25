...
<head>
    ...
    <title>WBG24 Dashboar Add Static Page</title>
                                ...
                                <div class="card-body pb-0">
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-3 ">
                                            <label for="" class="form-label fs-3 font-weight-bolder text-dark">Title: <i class="fas fa-asterisk fs-1 text-danger"></i></label>
                                            <input name="title" type="text" class="form-control form-control-user">
                                        </div>


                                        <div class="col-sm-12 mb-3">
                                            <label for="" class="form-label fs-3 font-weight-bolder text-dark">Matter: <i class="fas fa-asterisk fs-1 text-danger"></i></label>
                                            <textarea name="matter" id="editor" rows="6" class="form-control"></textarea>
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <label for="" class="form-label fs-3 font-weight-bolder text-dark">Priority: <i class="fas fa-asterisk fs-1 text-danger"></i></label>
