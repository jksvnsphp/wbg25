...
<head>
    ...
    <title>WBG24 Dashboard Shows News List</title>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <img src="./img/trade-shows/1657502349.jpeg" class=" img-thumbnail " alt="">
                                                    </td>
                                                    <td class="align-middle">
                                                    <p class="fs-2 font-weight-bold">A J Pvt. Ltd</p>
                                                    </td>
                                                    <td class="align-middle">
                                                        <p class="fs-2 font-weight-bold">Asias Largest and Indias Only Exhibition and Conference for Education and Training Resources</p>
                                                    </td>
