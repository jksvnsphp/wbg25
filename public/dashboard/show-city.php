...
<head>
    ...
    <title>WBG24 Dashboard Show City</title>
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    <input type="text" name="city_name" id="city_name" class="form-control" placeholder="Enter the city name">
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4 px-3">
                                                    <button class="btn btn-sm btn-primary">Add City</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
