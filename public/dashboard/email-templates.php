...
<head>
    ...
    <title>WBG24 Dashboard Email Template</title>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card rounded-0">
                                <div class="card-header d-flex justify-content-between rounded-0 py-2 bg-dark text-light font-weight-bolder">
                                    eMail Templates
                                    <a href="./bulk-mail-sender.php" class="btn btn-secondary">Bulk Send</a>
                                    <a href="./add-new-email-template.php" class="btn btn-sm btn-secondary">Add New</a>
                                </div>
                                <style>
