...
<head>
    ...
    <title>WBG24 Dashboard Export Customer</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="category" class="font-weight-bold fs-3">Category:</label>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="firm_name" value="1">
                                                <label class="form-check-label" for="firm_name">Firm Name</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="site_url" value="7">
                                                <label class="form-check-label" for="site_url">Site Url  </label>
                                            </div>
                                        </div>
