...
<head>
    ...
    <title>WBG24 Dashboard Show States</title>
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    <input type="text" name="state_name" id="name" class="form-control" placeholder="Enter the state name">
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4 px-3">
                                                    <button class="btn btn-sm btn-primary">Add State</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped " id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="./show-city.php">Badakhsha</a>
                                                    </td>
                                                    <td class="align-middle">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="./show-city.php">Badgis</a>
                                                    </td>
                                                    <td class="align-middle">
                                                        <a href="./show-city.php" >0</a>
                                                    </td>
                                                    <td class="align-middle">
                                                        <a href="" class="btn btn-sm btn-info"><i class="fas fa-edit    "></i></a>
                                                        <a href="" class="btn btn-sm btn-primary"><i class="fas fa-trash    "></i></a>
