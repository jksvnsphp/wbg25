        ...
        <div class="col-md-12 mt-2 bg-primary py-3">
            <div class="d-flex align-items-center justify-content-start mb-3">
                <h6 class="fs-5 text-light py-2 mt-0 px-3 mb-0">
                    ...
                    'buyer.quote-deal' => 'All Deals On Quotes',
                    'buyer.my-quote-deal' => 'My Activity Deals',
                    'buyer.supplier-quote-deal' => 'Suplliers Tender Deals',
                    default => 'My Deals On Quotes',
                    };
                    @endphp
                    {{$heading ?? 'All Deal On Quotes'}}
                </h6>
                <!-- <a href="{{ route('buyer.quote-deal') }}" class="btn btn-sm me-3 {{ Route::currentRouteName() == 'buyer.quote-deal' ? 'btn-secondary disabled' : 'btn-light' }}">All Deals</a>
                     <a href="{{ route('buyer.my-quote-deal') }}" class="btn btn-sm me-3 {{ Route::currentRouteName() == 'buyer.my-quote-deal' ? 'btn-secondary disabled' : 'btn-light' }}">My Activities Deals</a>
                    <a href="{{ route('buyer.supplier-quote-deal') }}" class="btn btn-sm {{ Route::currentRouteName() == 'buyer.supplier-quote-deal' ? 'btn-secondary disabled' : 'btn-light' }}">Suppliers Deals</a> -->
            </div>
                            ...
                            <tbody>
                                ...
                                <tr id="row-{{ $quote->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('buyer.offer.quote-deal',[$quote->quotation->slug,$quote->id]) }}" class="btn btn-sm btn-primary">Details</a>
                                        @endif
                                    </td>
                                    <td>
                                        @if (isset($quote->status) && $quote->status == 'accept')
