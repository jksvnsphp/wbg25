    ...
    <div class="row">
        <div class="col-md-12 mt-2 bg-primary py-3">
            ...
            <div class="card rounded-0">
                <div class="row">
                    <div class="col-md-10">
                        <form action="{{ route('buyer.update.quotation') }}" method="post" enctype="multipart/form-data" class="card-body">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="mt-2">
                                            <img id="preview_1"
                                                src="@if ($quotation->image_1 != '') {{ asset('uploads/quotation/' . $quotation->image_1) }}
                                            @else
                                                https://placehold.co/500x500 @endif"
                                                alt="Preview 1"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="mt-2">
                                            <img id="preview_2"
                                                src="@if ($quotation->image_2 != '') {{ asset('uploads/quotation/' . $quotation->image_2) }}
                                            @else
                                                https://placehold.co/500x500 @endif"
                                                alt="Preview 2"
                                                style="width: 150px; height: 150px; border-radius: 12px; border: 1px solid #ddd; object-fit: cover;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="mt-2">
                                            <img id="preview_3"
                                                src="@if ($quotation->image_3 != '') {{ asset('uploads/quotation/' . $quotation->image_3) }}
                                            @else
                                                https://placehold.co/500x500 @endif"
                                                alt="Preview 3"
                                                style="width: 150px; height: 150px; border-radius: 12px; border: 1px solid #ddd; object-fit: cover;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="mt-2">
                                            <img id="preview_4"
                                                src="@if ($quotation->image_4 != '') {{ asset('uploads/quotation/' . $quotation->image_4) }}
                                            @else
                                                https://placehold.co/500x500 @endif"
                                                alt="Preview 4"
                                                style="width: 150px; height: 150px; border-radius: 12px; border: 1px solid #ddd; object-fit: cover;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="estimated" class="fw-bolder form-label">Estimated Quantity:</label>
                                        <input type="text" name="quantity" value="{{ $quotation->quantity ?? '' }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="type">
                                            <option @selected($quotation->type == 'product_inquiry') value="product_inquiry">Product Inquiry
                                            </option>
                                            <option @selected($quotation->type == 'service_inquiry') value="service_inquiry">Service Inquiry
                                            </option>
                                            ...
                                            <option @selected($quotation->type == 'one_time_purchase') value="one_time_purchase">One-time
                                                Purchase</option>
                                            <option @selected($quotation->type == 'recurring_order') value="recurring_order">Recurring Order
                                            </option>
