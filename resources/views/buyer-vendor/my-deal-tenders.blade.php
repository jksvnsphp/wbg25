        ...
        <div class="row">
            <div class="col-md-12 mt-2 bg-primary py-3">
                <div class="d-flex align-items-center justify-content-start mb-3">
                    <h6 class="fs-5 text-light py-2 mt-0 px-3 mb-0">My Deals On Tenders</h6>
                </div>
                                        ...
                                        <tr id="row-{{ $quote->id }}">
                                            ...
                                            <td>
                                                @if (isset($quote->status) && $quote->status == 'accept')
                                                   <a href="{{ route('buyer.deal-detail.tender',[$quote->tender->slug,$quote->id]) }}" class="btn btn-sm btn-primary">Details</a>
                                                @endif
                                            </td>
                                            <td>
                                                @if (isset($quote->status) && $quote->status == 'accept')
                                                    <div
                                                        ...
                                                        @if ($quote->user_id == auth()->user()->id)
                                                            <button
                                                                ...
                                                                data-phone="{{ $vendor->phone ?? '' }}" data-title="Seller Contact Info" type="button"
                                                        ...
                                                        @elseif ($quote->vendor_id == auth()->user()->id)
                                                            <button
                                                                ...
                                                                data-phone="{{ $sender->phone ?? '' }}" data-title="Buyer Contact Info" type="button"
                                                                class="btn btn-primary btn-sm contact-btn">
                                                                Buyer Contact
                                                            </button>
                                                        @endif
                    ...
                    <form method="post" id="contact_form" class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="tender_id"   id="tender_id" value="{{ $tender->id ?? null }}">
