...
<body>
    ...
    <div class="email-container">
        ...
        <div class="order-details">
            <p>Dear {{ $user_name }},</p>
            <p>Thank you for your order! We're excited to inform you that your order has been successfully placed for
                        ...
                        @foreach ($order_items as $item)
                            <tr>
                                <td>
                                    ...
                                    {{ str_pad($item->id, 9, '0', STR_PAD_LEFT) }}
                                </td>
                                <td>
            ...
            <h2>Seller Payment Method Info</h2>
            <div class="order-items">
                <table>
                    <thead>
                        <tr>
...
{{ $seller_name ?? '' }}
            ...
            <div class="order-summary">
                ...
                <p><strong>Payable Amount:</strong> €{{ number_format($total_amount+$shipping_cost, 2) }}</p>
            </div>
