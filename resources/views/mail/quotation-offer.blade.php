...
<head>
    ...
    <title>Quote Received on Quotation</title>
    <style>
        body {
    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="offer-details">
                <p>Quotation: <span>{{ $tenderName}}</span></p>
                <p>Estimated Price: <span>${{ number_format($offer_price, 2) }}</span></p>
                <p>Offer By: <span>{{ $user_name }}</span></p>
                <p>Mail Id: <span>{{ $user_email }}</span></p>
            </div>
            <div class="tender-image">
                <img src="{{ $image }}" alt="Quotation Image">
            </div>
