    ...
    <div class="col-md-3">
        <div class="card shadow-sm h-100">
            <div class="card-body text-center">
                <h6 class="fw-bold mb-3">How to set Multiply Product Category</h6>

                <div class="ratio ratio-16x9">
                     
                        <video controls preload="metadata" style="width:100%; border-radius:6px;">
                            <source src="{{ asset('uploads/member_packages/How to set Multiply Product Category.mp4') }}" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                </div>

                <small class="text-muted d-block mt-2">
                    Watch this video to understand  How to set  product Category
                </small>
            </div>
        </div>
    </div>
            ...
            <div class="col-6">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="listingType"
                        id="spotlight_listing" checked value="spotlight">
                    <label class="form-check-label fw-bold text-primary" for="spotlight_listing">
                        Spotlight Store Listing
                    </label>
                </div>
            </div>
        </div>
