...
{{$heading ?? 'All Deal Quotes'}}
                     ...
                     <a href="{{ route('seller.my-quote-deal') }}" class="btn btn-sm me-3 {{ Route::currentRouteName() == 'seller.my-quote-deal' ? 'btn-secondary disabled' : 'btn-light' }}">My Activities Deals</a>
                    <a href="{{ route('seller.supplier-quote-deal') }}" class="btn btn-sm {{ Route::currentRouteName() == 'seller.supplier-quote-deal' ? 'btn-secondary disabled' : 'btn-light' }}">Suppliers Deals</a>
                </div>
