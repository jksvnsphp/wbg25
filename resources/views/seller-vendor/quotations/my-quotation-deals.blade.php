    ...
    <div class="row">
        <div class="col-md-12 mt-2 bg-primary py-3">
            <div class="d-flex align-items-center justify-content-start mb-3">
                ...
                <a href="{{ route('seller.my-quote-deal') }}" class="btn btn-sm me-3 {{ Route::currentRouteName() == 'seller.my-quote-deal' ? 'btn-secondary disabled' : 'btn-light' }}">Selling Quotation Deals</a>
                <a href="{{ route('seller.supplier-quote-deal') }}" class="btn btn-sm {{ Route::currentRouteName() == 'seller.supplier-quote-deal' ? 'btn-secondary disabled' : 'btn-light' }}">Buying Quotation Deals</a>
            </div>
