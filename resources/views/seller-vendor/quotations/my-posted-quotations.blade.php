        ...
        <div class="row">
            <div class="col-md-12 mt-2 bg-primary py-3">
                <div class="d-flex align-items-center justify-content-start mb-3">
                    ...
                    <a href="{{ route('myquotations.show') }}" class="btn btn-sm me-3 {{ Route::currentRouteName() == 'myquotations.show' ? 'btn-secondary disabled' : 'btn-light' }}">Active</a>
                    <a href="{{ route('myexpired.quotations.show') }}" class="btn btn-sm {{ Route::currentRouteName() == 'myexpired.quotations.show' ? 'btn-secondary disabled' : 'btn-light' }}">Inactive</a>
                </div>
                                ...
                                <tbody>
                                    @foreach ($quotations as $quotation)
                                        <tr @if($quotation->isRead==0) class="table-info"  @endif>
                                            ...
                                            <td>
                                                <a style="white-space: nowrap;" href="{{ route('seller.edit.quotation',$quotation->id) }}" title="ReList" class="btn btn-sm btn-secondary">
