                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        @else
                                        <div class="mt-2">
                                            <img id="preview_1" src="https://placehold.co/500x500 " alt="Preview 1"
                                                style="width: 150px; height: 150px; border-radius: 12px; border: 1px solid #ddd; object-fit: cover;">
                                        </div>
                                        @endif
                                        @error('image_1')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        @else
                                        <div class="mt-2">
                                            <img id="preview_2" src="https://placehold.co/500x500 " alt="Preview 2"
                                                style="width: 150px; height: 150px; border-radius: 12px; border: 1px solid #ddd; object-fit: cover;">
                                        </div>
                                        @endif
                                        @error('image_2')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        @else
                                        <div class="mt-2">
                                            <img id="preview_3" src="https://placehold.co/500x500 " alt="Preview 3"
                                                style="width: 150px; height: 150px; border-radius: 12px; border: 1px solid #ddd; object-fit: cover;">
                                        </div>
                                        @endif
                                        @error('image_3')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        @else
                                        <div class="mt-2">
                                            <img id="preview_4" src="https://placehold.co/500x500 " alt="Preview 4"
                                                style="width: 150px; height: 150px; border-radius: 12px; border: 1px solid #ddd; object-fit: cover;">
                                        </div>
                                        @endif
                                        @error('image_4')
