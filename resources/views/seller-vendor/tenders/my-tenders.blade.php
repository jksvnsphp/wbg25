        ...
        <div class="col-md-12 mt-2 bg-primary py-3">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('seller.get.tender') }}" class="btn btn-sm me-3 {{ Route::currentRouteName() == 'seller.get.tender' ? 'btn-secondary disabled' : 'btn-light' }}">Selling Tender Deals</a>
                    <a href="{{ route('seller.get.expired-tender') }}" class="btn btn-sm {{ Route::currentRouteName() == 'seller.get.expired-tender' ? 'btn-secondary disabled' : 'btn-light' }}">Buying Tender Deals</a>
                </div>
