                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="text-center">
                                                    Deal Done
                                                    {{ date('d M, Y', strtotime($tenderOffer->created_at)) }}
                                                </h6>
                                                <h6 class="text-center">CET
                                                    {{ date('h:i A', strtotime($tenderOffer->created_at)) }}
                                                </h6>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="text-secondary fw-semibold">
                                                    ...
                                                    Sale Provision
                                                    @if ($tender->currency == 'usd')
                                                    USD &dollar; {{ $commission ?? 0 }}
                                                    @else
                                                    EURO &euro; {{ $commission ?? 0 }}
                                                    @endif
                                                </span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <img src="{{ asset('world-business/images/vendor-ico/businessdeal.jpg') }}" style="height: 4rem" alt="" />
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="row mt-3">
                                ...
                                <div style="border-right: 1px solid #ddd"
                                    ...
                                    <p class="mt-3 d-block"><strong>Shipment Company:</strong>
                                        {{ $tenderOffer->shippment_company ?? '' }}
                                    </p>
                                    <p><strong>Shipment Tracking Number:</strong>
                                        {{ $tenderOffer->tracking_number ?? '' }}
                                    </p>
                                    @else
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="hidden" name="receiver_id"
                                value="{{ $tenderOffer->vendor_id ?? null }}">
...
<script>
    function changePayment(id, status) {
        ...
        let orderItemId = id;
        $.ajax({
            url: '{{ route("seller.status.deal-tender") }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
