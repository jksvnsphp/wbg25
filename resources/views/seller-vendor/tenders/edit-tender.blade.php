                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <label for="image1" class="form-label">Image 1 <small class="text-danger">(500px X 500px) <i class="fa fa-asterisk text-secondary" style="font-size:10px;" aria-hidden="true"></i></small></label>
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <label for="image2" class="form-label">Image 2 <small class="text-danger">(500px X 500px)</small></label>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row mt-3">
                                            <div class="col-md-4">
                                                <div class="form-group mb-2">
                                                    <label for="rate_table" class="form-label">Enter Shipping Partner</label>
