                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="image1" class="form-label">Image 1 <small
                                                    class="text-danger">(480px X 360px) <i
                                                        class="fa fa-asterisk text-secondary" style="font-size:10px;"
                                                        aria-hidden="true"></i></small></label>
                                            <input type="file" name="image_1" id="img1" class="form-control" />
                                            @if ($tender->image_1 != ' ' && isset($tender->image_1))
                                                <div class="mt-2 position-relative rounded-2"
                                                    style="width: 100px;height:100px;">
                                                    <img src="{{ asset('uploads/tender/' . $tender->image_1) }}"
                                                        class="rounded-2 removeImg" width="100" height="100" />
                                                    <span data-col="image_1" data-id="{{ $tender->id ?? null }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="image2" class="form-label">Image 2 <small
                                                    class="text-danger">(480px X 360px)</small></label>
                                            <input type="file" name="image_2" id="img2" class="form-control" />
                                            @if ($tender->image_2 != ' ' && isset($tender->image_2))
                                                <div class="mt-2 position-relative rounded-2"
                                                    style="width: 100px;height:100px;">
                                                    <img src="{{ asset('uploads/tender/' . $tender->image_2) }}"
                                                        class="rounded-2 removeImg" width="100" height="100" />
                                                    <span data-col="image_2" data-id="{{ $tender->id ?? null }}"
                                                        class="removeImg position-absolute top-0  btn btn-sm btn-primary"
                                                        style="right:0;">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="image3" class="form-label">Image 3 <small
                                                    class="text-danger">(480px X 360px)</small></label>
                                            <input type="file" name="image_3" id="img3" class="form-control" />
                                            @if ($tender->image_3 != ' ' && isset($tender->image_3))
                                                <div class="mt-2 position-relative rounded-2"
                                                    style="width: 100px;height:100px;">
                                                    <img src="{{ asset('uploads/tender/' . $tender->image_3) }}"
                                                        class="rounded-2 removeImg" width="100" height="100" />
                                                    <span data-col="image_3" data-id="{{ $tender->id ?? null }}"
                                                        class="removeImg position-absolute top-0  btn btn-sm btn-primary"
                                                        style="right:0;">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="image4" class="form-label">Image 4 <small
                                                    class="text-danger">(480px X 360px)</small></label>
                                            <input type="file" name="image_4" id="img4" class="form-control" />
                                            @if ($tender->image_4 != ' ' && isset($tender->image_4))
                                                <div class="mt-2 position-relative rounded-2"
                                                    style="width: 100px;height:100px;">
                                                    <img src="{{ asset('uploads/tender/' . $tender->image_4) }}"
                                                        class="rounded-2 removeImg" width="100" height="100" />
                                                    <span data-col="image_4" data-id="{{ $tender->id ?? null }}"
                                                        class="removeImg position-absolute top-0  btn btn-sm btn-primary"
                                                        style="right:0;">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="image3" class="form-label">Image 5 <small
                                                    class="text-danger">(480px X 360px)</small></label>
                                            <input type="file" name="image_5" id="img5" class="form-control" />
                                            @if ($tender->image_5 != ' ' && isset($tender->image_5))
                                                <div class="mt-2 position-relative rounded-2"
                                                    style="width: 100px;height:100px;">
                                                    <img src="{{ asset('uploads/tender/' . $tender->image_5) }}"
                                                        class="rounded-2 removeImg" width="100" height="100" />
                                                    <span data-col="image_5" data-id="{{ $tender->id ?? null }}"
                                                        class="removeImg position-absolute top-0  btn btn-sm btn-primary"
                                                        style="right:0;">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="image6" class="form-label">Image 6 <small
                                                    class="text-danger">(480px X 360px)</small></label>
                                            <input type="file" name="image_6" id="img6" class="form-control" />
                                           @if ($tender->image_6 != ' ' && isset($tender->image_6))
                                                <div class="mt-2 position-relative rounded-2"
                                                    style="width: 100px;height:100px;">
                                                    <img src="{{ asset('uploads/tender/' . $tender->image_6) }}"
                                                        class="rounded-2 removeImg" width="100" height="100" />
                                                    <span data-col="image_6" data-id="{{ $tender->id ?? null }}"
                                                        class="removeImg position-absolute top-0  btn btn-sm btn-primary"
                                                        style="right:0;">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
...
@section('seller-custome-js')
    ...
    <script>
        ...
        let rowIndex = 0;
        const shippingRateCosts = @json($tender->rate_table->shipping_rate_costs);
