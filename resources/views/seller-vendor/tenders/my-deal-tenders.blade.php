...
{{$heading ?? 'All Deal On Tender'}}
                     ...
                     <a href="{{ route('seller.my-deal.offer.tender') }}" class="btn btn-sm me-3 {{ Route::currentRouteName() == 'seller.my-deal.offer.tender' ? 'btn-secondary disabled' : 'btn-light' }}">My Activities Deals</a>
                    <a href="{{ route('seller.supplier-deal.offer.tender') }}" class="btn btn-sm {{ Route::currentRouteName() == 'seller.supplier-deal.offer.tender' ? 'btn-secondary disabled' : 'btn-light' }}">Suppliers Deals</a>
                </div>
