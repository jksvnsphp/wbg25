            ...
            <div class="card shadow rounded-0 my-4">
                ...
                <div class="card-body">
                    <div class="row details-card-v justify-content-center">
                        <h5 class="text-success fs-5 text-center">Congratulation, your tender has {{ $what=="add"?"uploaded":"edited" }} successfully and listed
                            online now!</h5>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <a class="d-block text-primary mt-2" href="{{route('show.tender',$tender->slug)}}">View Listed Tender</a>
