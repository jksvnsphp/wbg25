    ...
    <section class="container-fluid">
        <div class="row">
            <div class="col-md-12 bg-primary py-3">
                <h6 class="fs-5 text-light py-3 px-3">Profile Meta Datas</h6>
                <div class="card shadow rounded-0">
                    <div class="card-body">
                        ...
                        <p>
                            ...
                            used for your seller profile
                        </p>
                        <form method="post" action="{{ route('seller.update.profile-meta-data') }}" class="row">
                            @csrf
                            <div class="col-md-7">
