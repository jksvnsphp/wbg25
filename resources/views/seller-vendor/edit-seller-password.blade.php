        ...
        <div class="row">
            <div class="col-md-12  bg-primary py-3 pt-1 pb-5">
                ...
                <form method="post" id="editsellercompany" class="card rounded-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 all-none">
                                <input type="hidden" name="user_id" value="{{ $user->id }}">
                                <div class="form-group mb-3 all-none">
                            ...
                            <div class="col-md-6 position-relative all-none">
                            ...
                            <h6 class="mt-3 d-none fw-bold all-none">Certification</h6>
                            <div class="col-md-12 d-none my-4 all-none">
                                <div class="row">
                                    @php
                                        $certifications = [
                                            'HACCP',
                            ...
                            <h6 class="mt-3  fw-bold all-none">Company Description</h6>
                            <div class="col-md-12 all-none">
                                <div class="form-group mb-3">
                                    <textarea name="description" class="form-control" id="description" rows="7">{{ $user->company->company_desc ?? '' }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3 all-none">
                                <div class="form-group mb-3">
                            ...
                            <div class="col-md-12 mt-3 all-none">
                                <div class="row">
                                    <div class="col-md-3">
...
@section('seller-custome-js')
    ...
    if (!password || !confirmPassword) {
        toastr.error('Password and Confirm Password are required');
        return false;
    }
            ...
            $('#sendOtpMethodBtn').on('click', function() {
               ...
               // console.log('Selected country code:', countryCode);
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: { otp_method: otpMethod, phone:dialCode+phone,email:email },
                    success: function(response) {
                        if (response.success) {
