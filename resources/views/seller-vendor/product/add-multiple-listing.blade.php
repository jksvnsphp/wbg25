    ...
    <section class="container-fluid">
        <div class="row">
            <div class="col-md-12 mt-2 bg-primary py-3">
                <h6 class="fs-5 text-light py-3 px-3">Add Multiply Product</h6>
                ...
                <div class="card shadow rounded-0">
                    ...
                    <form class="card-body" id="add_product_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            @livewire('category-suggestion-multiple')
...
@section('seller-custome-js')
    ...
    <script>
    ClassicEditor
        .create(document.querySelector('#div_editor1'), {
            // You can configure toolbar items here if needed
        })
        .catch(error => {
            console.error(error);
        });
