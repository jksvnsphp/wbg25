            ...
            <div class="col-md-12 mt-2 bg-primary py-3">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center">
                        <h6 class="fs-5 text-light py-2 mt-2 px-3">My Products List</h6>
                        <a href="{{ route('seller.get.products') }}"
                            class="btn btn-sm  me-3 {{ Route::currentRouteName() == 'seller.get.products' ? 'btn-secondary disabled' : 'btn-light' }}">
                            Active
                        </a>

                        <a href="{{ route('seller.get.inactive.products') }}"
                            class="btn btn-sm {{ Route::currentRouteName() == 'seller.get.inactive.products' ? 'btn-secondary disabled' : 'btn-light' }}">
                            Inactive
                        </a>
                            ...
                            <table class="table table-bordered align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Status</th>
                                        @if (Route::currentRouteName() == 'seller.get.inactive.products')
                                            <th>Expired on</th>
                                            <th>Re-List</th>
                                        @endif
                                        <th>Action</th>
                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr data-product-id="{{ $product->id }}" @if($product->isRead==0) class="table-info"   @endif>
                                            <td>
                                            ...
                                            @if (Route::currentRouteName() == 'seller.get.inactive.products')
                                                <td>
                                                    <span class="text-danger">
                                                        {{ isset($product->expired)?date('Y-M-d',strtotime($product->expired)):'' }}
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                @if ($product->isMultiple == 1) {{ route('seller.edit.multiply-list', $product->id) }}
                                                 ...
                                                 "
                                                        title="Re-List & Sell" class="btn btn-primary btn-sm me-2">
                                                        Re-List & Sell
                                                    </a>
                                                </td>
                                            @endif
                                            ...
                                            <td>
                                                ...
                                                @if ($product->isMultiple == 1) {{ route('seller.edit.multiply-list', $product->id) }}
                                                 ...
                                                 "
                                                        ...
                                                        <i class="fa fs-5 text-white fa-pencil-square"
                                                            aria-hidden="true"></i>
                                                    </a>
                                                @endif
