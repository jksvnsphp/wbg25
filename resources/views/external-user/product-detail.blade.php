                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 product_details_single" style="border: 1px solid #ddd">
                            ...
                            <p class="text-center fw-bold">
                                {{ preg_replace('/([a-z])([A-Z])/', '$1 $2', $product->item_condition) }}</p>
            ...
            <div class="col-xl-3 my-4">
                <div class="card rounded-0">
                    <div class="card-header rounded-0 d-flex justify-content-between">
                        <h5 class="fw-bold">
                            {{ isset($product->vendor->company->name) ? $product->vendor->company->name : '' }}</h5>
                        <div>
                            ...
                            <div class="col-md-8">
                                <p class="fontp">
                                    @if (isset($product->product_setting->isReturnAccept) && $product->product_setting->isReturnAccept == 1)
                                        <strong class="fw-semibold">{{ $product->product_setting->return_timeline }} Days
                                            returns.
