                            ...
                            <ul class="dropdown-menu p-3">
                                ...
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.suppliers') }}">Suppliers</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.news.show') }}">Suppliers News</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.spotlight') }}">Spotlight Stores</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                ...
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.product-video.show') }}">Product Videos</a>
                                </li>

                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.type.products', 'limited-offer') }}">Limited Offers</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.type.products', 'hot') }}">Hot Products</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.type.products', 'bulk-buying') }}">Bulk Buying</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.type.products', 'daily-deals') }}">Daily Deals</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('all.tenders') }}">Tenders</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <form method="get" action="{{ route('search') }}" class="form-search d-flex">
                                ...
                                <input type="search" value="{{ request('q') }}" name="search"
                    ...
                    <div class="row d-flex align-items-center justify-content-around">
                        <div class="col-md-4 mt-md-0 mt-3 d-flex justify-content-center log-profile">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="profile">
                                    <img src="@if (isset(auth()->user()->profile) && auth()->user()->profile != '') {{ asset('uploads/profile/' . auth()->user()->profile) }}
                                    @else
                    ...
                    <ul class="navbar-nav navbar-left mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu p-2">
                                ...
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('seller.bank.detail') }}"><i
                                            class="fa-solid me-2 fa-bank"></i> My Bank Details</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('seller.social-media') }}"><i
                                            class="fa-solid me-2 fa-globe"></i>My Social Media</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('seller.vendor.gallery') }}"><i
                                            class="fa-solid me-2 fa-image"></i>Profile Images</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0" href="{{ route('seller.search.keys') }}">
                                ...
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('seller.profile.meta-data') }}">
                                        <i class="fa-brands fa-searchengin me-2"></i>
                                        Profile Meta Datas
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('seller.business.symbols') }}"><i
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('seller.multiple-listing') }}"><i
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0" href="{{ route('user.get.quotes') }}"><i
                                            class="fa-solid me-2 fa-sheet-plastic"></i>List
                                        Request</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0"
                                        href="{{ route('myquotations.show') }}"><i
                                            class="fa-solid me-2 fa-sheet-plastic"></i> My Listed
                                        Requests</a>
                                </li>
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0" href="{{ route('seller.quote-deal') }}">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="d-lg-inline d-none">|</span>
                                <img src="{{ asset('world-business/images/icons8-microphone-96.png') }}"
                                    height="17" width="17" alt="" />
                                My News
                            </a>
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0" href="{{ route('seller.add.news') }}"><i
                                            class="fa-solid me-2 fa-microphone"></i>List News</a>
                                </li>

                                <li>
                                    <a class="dropdown-item mx-0 pb-1 px-0" href="{{ route('seller.my.news') }}"><i
            ...
            <nav class="navbar bottomnav navbar-expand-xl bg-white py-0">
                ...
                <div class="collapse subNav navbar-collapse" id="navbarNavDropdown1">
                    <ul class="navbar-nav navbar-left ">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('buyer.complete.profile', auth()->user()->ref_no ?? '') }}"
                                class="nav-link">
                                <span class="d-lg-inline d-none">|</span>
...
<div class="modal fade" id="customLanguageModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="customLanguageModalLabel" aria-hidden="true">
