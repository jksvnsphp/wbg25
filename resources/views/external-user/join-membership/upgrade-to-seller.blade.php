                        ...
                        <div class="package-pck">
                            <ul class="package-content list-unstyled">
                                ...
                                <li>{{ $package->name == 'Bronce Package' || $package->name == 'Silver Package'
                                    ...
                                    listing limit<span>{{ $package->productLimit }} <img style="cursor: pointer;"
                                            title="List & sell Products in Number of the Member Package included Limit. Normal Product listings works by Duration Time, Multiply Product listings works by Number of Quantity Before Seller can start to list Products on WBG24.com, the accepted Payment Method for Buyers need to save "
                            ...
                            <div class="package-footer">
                                <a href="{{ route('buyer.upgrade.seller', [$package->code, $buyer->ref_no]) }}"
