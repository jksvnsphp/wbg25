        ...
        <div class="row">
            <div class="col-md-2 col-sm-4 d-flex justify-content-end align-items-start sidebar">
                <nav class="navbar  navbar-expand-lg w-100">
                    ...
                    <form method="get" action="{{ route('all.type.products', $type) }}"
                        class="collapse w-100 navbar-collapse mx-0" style="margin-top: 1rem !important"
