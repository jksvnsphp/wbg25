                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 my-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        <label for="" class="form-label">City <span class="text-danger fs-5">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        <label for="" class="form-label">ZIP Code <span class="text-danger fs-5">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        <label for="" class="form-label">Street <span class="text-danger fs-5">*</span></label>
                                        <input type="text" class="form-control" name="street" value="{{ session('street')?session('street'):'' }}" placeholder="Enter street name" required />
                                        @error('street')
                                        <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group mb-2">
                                                <label for="categorySelect" class="form-label">Company Category <span class="text-danger fs-5">*</span> </label>
                                                <select name="company_category" id="categorySelect" class="form-select" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-2">
                                                <label for="subCategorySelect" class="form-label">Sub Category <span class="text-danger fs-5">*</span></label>
                                                <select
                                                    required
    ...
    $(document).ready(function() {
        ...
        $('#sendotpbtn').on('click', function(e) {
            ...
            var fields = {
                ...
                'company_category': $('#categorySelect').val(),
                'company_sub_category': $('#subCategorySelect').val(),
            };
