...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ route('admin.email_templates.update', $template->id) }}">
        ...
        <div class="mb-3">
            <label>Type</label>
            <input type="text" name="type" value="{{ $template->type }}" class="form-control" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="body" id="editor" rows="10" class="form-control" required>{{ $template->body }}</textarea>
        </div>
