            ...
            <div class="col-md-12 mb-3">
                <div class="card my-4 rounded-0 " id="category_card">
                    <div
                        ...
                        Edit End Sub Category
                    </div>
                    <form class="card-body pb-0" method="post" action="{{ route('admin.update.endsubcategory') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @enderror
                                @if ($pcat->image != '')
                                    <img src="{{ asset('uploads/products/endSubCategory/' . $pcat->image) }}" style="height: 4rem;"
                                        class="mt-2" alt="">
                                @endif
