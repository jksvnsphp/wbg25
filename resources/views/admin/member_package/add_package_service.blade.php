            ...
            <div class="col-12 mb-3">
                <div class="card rounded-0">
                    ...
                    <div class="card-body pb-0">
                        <form method="post" action="{{route('admin.store.package.service')}}" class="form-group row">
                            @csrf
                            <div class="col-12">
                                <div class="row">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-9 mb-3">
                                        <div class="input-check d-flex align-items-center">
                                            ...
                                            <input checked type="radio" name="isBronce" class="mx-2" id="isBronceon"
                                                value="1">
                                            <label for="isBronceoff"
                                                class=" font-weight-bolder fs-2 text-dark mb-0 pb-0">No</label>
                                            <input type="radio" name="isBronce" class="mx-2" id="isBronceoff"
                                                value="0">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-9 mb-3">
                                        <div class="input-check d-flex align-items-center">
                                            <label for="isSilveron"
                                                class="  font-weight-bolder text-dark fs-2 mb-0 pb-0">Yes</label>
                                            <input checked type="radio" name="isSilver" class="mx-2" id="isSilveron"
                                                value="1">
                                            <label for="isSilveroff"
                                                class=" font-weight-bolder fs-2 text-dark mb-0 pb-0">No</label>
                                            <input type="radio" name="isSilver" class="mx-2" id="isSilveroff"
                                                value="0">
                                        </div>
                                    </div>
                                </div>
                                <div class="row ">
                                    ...
                                    <div class="col-9 mb-3">
                                        <div class="input-check d-flex align-items-center">
                                            <label for="isGoldon"
                                                class="  font-weight-bolder text-dark fs-2 mb-0 pb-0">Yes</label>
                                            <input checked type="radio" name="isGold" class="mx-2" id="isGoldon"
                                                value="1">
                                            <label for="isGoldoff"
                                                class=" font-weight-bolder fs-2 text-dark mb-0 pb-0">No</label>
                                            <input type="radio" name="isGold" class="mx-2" id="isGoldoff"
                                                value="0">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-9 mb-3">
                                        <div class="input-check d-flex align-items-center">
                                            <label for="isPlatinumon"
                                                class="  font-weight-bolder text-dark fs-2 mb-0 pb-0">Yes</label>
                                            <input checked type="radio" name="isPlatinum" class="mx-2" id="isPlatinumon"
                                                value="1">
                                            <label for="isPlatinumoff"
                                                class=" font-weight-bolder fs-2 text-dark mb-0 pb-0">No</label>
                                            <input type="radio" name="isPlatinum" class="mx-2" id="isPlatinumoff"
                                                value="0">
                                        </div>
                                    </div>
                                </div>
