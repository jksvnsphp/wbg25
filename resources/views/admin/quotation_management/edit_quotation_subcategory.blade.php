            ...
            <div class="col-md-12 mb-3">
                <div class="card my-4 rounded-0 " id="category_card">
                    <div class="card-header d-flex justify-content-between align-items-center rounded-0 py-2 bg-dark text-light font-weight-bolder">
                        Edit Quotation Sub Category
                    </div>

                    <form class="card-body pb-0" method="post" action="{{ route('admin.update.quotation.subcategory') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @enderror
                                @if ($pcat->image != '')
                                    <img src="{{ asset('uploads/quotation_category/' . $pcat->image) }}" style="height: 4rem;"
                                        class="mt-2" alt="">
                                @endif
