...
<head>
    ...
    <title>New Counter Offer Received for Your Tender/RFQ!</title>
    <style>
        ...
        .header { background: linear-gradient(90deg, #0069d9, #00bfff); color: #fff; padding: 25px; text-align: center; }
...
<div class="email-wrapper">
    <div class="header">
        <h2>💼 New Counter Offer Received for Your Tender/RFQ!</h2>
    </div>
    <div class="content">
        <p>Dear <strong>{{ $buyer_name ?? 'Buyer' }}</strong>,</p>
        <p>The Seller has responded with a Counter Offer for your RFQ/Tender <strong>{{ $tender_id ?? '—' }}</strong>. Please review and take action.</p>
        ...
        <ul>
            <li>✔ Review the Seller’s Counter Offer carefully.</li>
            <li>✔ Accept, reject, or propose another offer.</li>
            <li>✔ Stay in touch with the Seller for negotiation.</li>
        </ul>

        <p style="text-align:center;">
            <a href="{{ $dashboard_link ?? '#' }}" class="cta-button">Review Offer</a>
        </p>
