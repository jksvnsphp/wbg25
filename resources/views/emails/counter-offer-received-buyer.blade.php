...
<p>Dear {{ $buyer_name }},</p>
<p>A seller submitted a counter offer for RFQ <strong>{{ $rfq_id }}</strong>.</p>

<ul>
<li><strong>Seller:</strong> {{ $seller_name }}</li>
<li><strong>Original Offer:</strong> {{ $original_price }}</li>
<li><strong>Counter Offer:</strong> {{ $counter_price }}</li>
</ul>

<p style="text-align:center;">
<a class="btn" href="{{ $buyer_dashboard_link }}">Respond</a>
</p>
