...
<head>
    ...
    <title>New Offer Received for Your Tender/RFQ!</title>
    <style>
...
<div class="email-wrapper">
    <div class="header">
        <h2>💼 New Offer Received for Your Tender/RFQ!</h2>
    </div>
    <div class="content">
        <p>Dear <strong>{{ $buyer_name ?? 'Buyer' }}</strong>,</p>
        <p>You’ve received a new Offer for your RFQ/Tender <strong>{{ $tender_id ?? '—' }}</strong> on WBG24.com.</p>
        ...
        <ul>
            ...
            <li>✔ Contact the Seller if you need more information.</li>
            <li>✔ Accept, reject, or negotiate directly from your dashboard.</li>
        </ul>

        <p style="text-align:center;">
            <a href="{{ $dashboard_link ?? '#' }}" class="cta-button">Review Offers</a>
        </p>
